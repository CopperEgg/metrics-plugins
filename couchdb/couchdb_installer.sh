...
setup_couchdb()
{
    ...
    echo "Enter tags you want to add to this CouchDB(optional): "
...
setup_upstart_init()
{
    INIT_FILE="/etc/init/revealmetrics_couchdb.conf"
    if [ -e "$INIT_FILE" ]; then
...
setup_standard_init()
{
    ...
    INIT_FILE="/etc/init.d/revealmetrics_couchdb"
    if [ -e "$INIT_FILE" ]; then
...
ENDINIT
    ...
    if [ -n "$CREATED_INIT" ]; then
        ...
        if [ -d "/etc/rc1.d" ]; then
            rm -f /etc/rc*.d/*revealmetrics_couchdb
            ln -s $INIT_FILE /etc/rc0.d/K99revealmetrics_couchdb
            ln -s $INIT_FILE /etc/rc1.d/K99revealmetrics_couchdb
            ln -s $INIT_FILE /etc/rc2.d/S99revealmetrics_couchdb
            ln -s $INIT_FILE /etc/rc3.d/S99revealmetrics_couchdb
            ln -s $INIT_FILE /etc/rc4.d/S99revealmetrics_couchdb
            ln -s $INIT_FILE /etc/rc5.d/S99revealmetrics_couchdb
            ln -s $INIT_FILE /etc/rc6.d/K99revealmetrics_couchdb
        elif [ -d "/etc/init.d/rc1.d" ]; then
            rm -f /etc/init.d/rc*.d/*revealmetrics_couchdb
            ln -s $INIT_FILE /etc/init.d/rc1.d/K99revealmetrics_couchdb
            ln -s $INIT_FILE /etc/init.d/rc2.d/S99revealmetrics_couchdb
            ln -s $INIT_FILE /etc/init.d/rc3.d/S99revealmetrics_couchdb
            ln -s $INIT_FILE /etc/init.d/rc4.d/S99revealmetrics_couchdb
            ln -s $INIT_FILE /etc/init.d/rc5.d/S99revealmetrics_couchdb
            ln -s $INIT_FILE /etc/init.d/rc6.d/K99revealmetrics_couchdb
            ln -s $INIT_FILE /etc/init.d/rcS.d/S99revealmetrics_couchdb
        fi
